...
class Settings(BaseSettings):
    ...
    system_prompt: str = (
        ...
        "- Severity/likelihood mismatch: SELECT n.cve_id, n.cvss_v31_score, "
        "e.probability FROM nvd_vulnerabilities n LEFT JOIN epss_scores e ON "
        "e.cve_id = n.cve_id WHERE n.cvss_v31_score >= 9.0 AND (e.probability < 0.01 "
        "OR e.probability IS NULL);\n"
